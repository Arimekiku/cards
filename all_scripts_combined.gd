#// Combined Godot scripts from project: all_scripts_combined.gd
#// Each section begins with a header line showing the original file path.
#
...
#
#
#// === FILES: card state scripts and minion states ===
#// (Included above earlier in this file — CardAimState, CardClickedState, CardDragState,
#// CardIdleState, CardReleasedState, CardStateMachine, CardBaseState,
#// MinionStateMachine, MinionIdleState, MinionBaseState, MinionAimState,
#// MinionAttackState, MinionStateMachine etc.)
#
#// Note: if you want, I can re-order or remove helper/resource files, or split
#// the combined file into only gameplay scripts vs UI scripts.
#
#// End of combined scripts file.
