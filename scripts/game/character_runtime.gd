...
var character_meta: CharacterMetadata
...
func _ready():
	...
	character_meta = game.player_metadata if side == Enums.CharacterType.PLAYER\
	else game.boss_metadata
	deck.initialize_deck(character_meta.deck)
	draw_start_hand()
